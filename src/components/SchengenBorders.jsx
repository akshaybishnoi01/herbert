    ...
    return (
        <div id='About' className='bg-offOrange md:py-[72px] py-16'>
            <div className='max-w-[1920px] mx-auto schengen relative'>
                <div className='max-w-[1318px] 2xl:max-w-[1590px] w-full flex lg:flex-row flex-col xl:gap-[144px] 2xl:me-auto md:gap-16 gap-14 2xl:justify-between justify-start items-center'>
                    <img className='xl:max-w-[701px] max-w-[580px] w-full xl:h-[602px] pointer-events-none' src={schengenImage} alt="#" />
                    <div className='lg:mx-0 lg:px-6 max-lg:container'>
                        ...
                        <ul className='list-disc pt-2 ps-6'>
