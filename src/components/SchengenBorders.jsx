                ...
                <div className='max-w-[1318px] w-full flex lg:flex-row flex-col xl:gap-[144px] md:gap-16 gap-14 justify-start items-center'>
                    ...
                    <div className='lg:mx-0 mx-6'>
                        ...
                        <ul className='list-disc pt-2 ps-5'>
                            <li className='font-normal text-base leading-6 text-gray'>Short-term stay regulations</li>
                            <li className='font-normal text-base leading-6 text-gray'>Entry requirements for the Schengen Area</li>
                            <li className='font-normal text-base leading-6 text-gray'>Border crossing procedures</li>
                        </ul>
                    </div>
                </div>
            </div>
