...
handbook'>
                <div className='flex lg:gap-[153px] gap-14 lg:flex-row flex-col lg:items-center lg:pb-[65px] pb-20'>
                    ...
                    <img className='md:max-w-[392px] max-w-[261px] max-lg:ms-[33px] w-full handbook-img pointer-events-none' src={menResidence} alt="#" />
                </div>
                <div className='border rounded-lg border-offGray max-w-[1440px] w-full bg-white'>
                    <p className='font-normal text-base text-gray leading-6 sm:p-6 p-4 max-w-[1140px] para-text'>
