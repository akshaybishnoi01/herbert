...
const NeedHelp = () => {
  return (
   <div id='Vision' className='max-w-[1920px] mx-auto'>
     <div className='container sm:translate-y-[120px] translate-y-[160px]'>
      <div className='bg-orange flex flex-col items-center justify-center sm:py-16 sm:p-0 p-5 rounded-xl'>
         <h3 className='font-rubik lg:text-5xl md:text-4xl sm:text-3xl text-2xl lg:leading-[56px] md:leading-10 sm:leading-9 leading-7 text-center text-white font-semibold max-w-[632px]'>
         Need Help in Your Visa? Ask Herbert Now!
         </h3>
         <p className='max-w-[528px] font-normal sm:text-base text-sm sm:leading-6 leading-[21px] text-white sm:pt-4 pt-3 md:pb-[42px] pb-8 text-center'>
