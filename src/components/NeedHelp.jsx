    ...
    <div id='Vision' className='max-w-[1920px] mx-auto'>
      <div className='container sm:translate-y-[120px] translate-y-[160px] need-help'>
        <div className='bg-orange flex flex-col items-center justify-center sm:py-16 sm:p-0 p-5 rounded-xl'>
          ...
          <p className='max-w-[528px] white-para font-normal sm:text-base text-sm sm:leading-6 leading-[21px] text-white sm:pt-4 pt-3 md:pb-[42px] pb-6 text-center'>
            Lorem ipsum dolor sit amet consectetur adipiscing eli mattis sit phasellus mollis sit aliquam sit nullam.
          </p>
          <div className='flex sm:flex-row flex-col sm:gap-4 gap-3 max-sm:w-full'>
