        ...
        <div id='Features' className='max-w-[1024px] w-full flex lg:justify-start justify-center items-center gap-[153px]'>
          <div className='max-w-[478px] w-full '>
            ...
            <div className='flex justify-center'>
              <img className='md:max-w-[392px] max-w-[261px] lg:hidden w-full my-8' src={menResidence} alt="Men Residence" />
            </div>
          ...
          <img className='residence-img max-w-[392px] lg:flex hidden w-full' src={menResidence} alt="Men Residence" />
        </div>
      </div>
    </div>
  );
